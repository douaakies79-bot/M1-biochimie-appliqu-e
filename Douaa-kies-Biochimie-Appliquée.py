...
#plt.ylabel("poucentage GC")
#plt.title("poucentage de GC par séquence")
#plt.show()
...
#7)calculer l'ecart-type du pourcentage GC
print("*************calcul de l'ecart type*************")
#calculer l'ecart-type du pourcentage de GC
average_=df["pourcentage GC"].mean()
print(f"pourcentage l'ecart-type de GC):{average_gc:.2f}%","\n\n")

#8)sauvegarde et chagementdes données avec panda 
